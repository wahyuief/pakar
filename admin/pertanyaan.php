...
$pertanyaan = $conn->query("SELECT * FROM pertanyaan");
?>
<div id="inner-container">
    <div id="page-content">
        ...
        <div class="row">
            <div class="col-md-6"><h2>Pertanyaan <small><a href="tambah.php?from=pertanyaan" class="hidden-lg hidden-md">Tambah Data</a></small></h2></div>
            <div class="col-md-6 text-right hidden-xs hidden-sm" style="line-height: 5;"><a href="tambah.php?from=pertanyaan" class="btn btn-primary">Tambah Data</a></div>
        </div>
        <div class="table-responsive">
            <table class="table table-striped table-hover table-bordered">
                ...
                <tbody>
                    <?php $i=1;while($user = $pertanyaan->fetch_assoc()): ?>
                    <tr>
                        <td><?php echo $i++; ?></td>
                        ...
                        <td>
                            <div class="btn-group">
                                <a href="./edit.php?from=pertanyaan&id=<?php echo $user['id']; ?>" data-toggle="tooltip" title="" class="btn btn-xs btn-success" data-original-title="Edit"><i class="fa fa-pencil"></i></a>
                                <?php if($user['id'] == $sess_id): ?><a href="javascript:void(0)" onclick="var c = confirm('Yakin ingin menghapus?');if(c){location.replace('./hapus.php?from=pertanyaan&id=<?php echo $user['id']; ?>')}" data-toggle="tooltip" title="" class="btn btn-xs btn-danger" data-original-title="Delete"><i class="fa fa-times"></i></a><?php endif; ?>
                            </div>
                        </td>
                    </tr>
                    <?php endwhile; ?>
